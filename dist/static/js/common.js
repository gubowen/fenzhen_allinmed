    ...
    show: function () {
        ...
        if ($(".ev-loading").length == 0) {
            $("body").append('<section class="middle-tip-box ev-loading">' +
                ...
                '<img src="/image/img00/common/save_complete.png" alt="loading...">' +
                '</figure>' +
...
common.popup = function (obj) {
    if ($(".popup").length == 0) {
        $("body").append('<section class="middle-tip-modal popup">' +
            ...
            '<figure class="middle-tip-box-text">' +
            (obj.hasImg ? '<img src="/static/img/img00/login/save_loading.png" alt="">' : '') +
...
var TempCache = {
    cache: function(value) {
      this.$store.state.EasyWayTempCache =  value;
    },
    getCache: function() {
        return this.$store.state.EasyWayTempCache;
    },
    ...
    removeItem: function(key) {
        return that.$store.state[key]='';
    },
    clear: function() {
        var wxBrowseAccessLockOn = this.$store.state.wxBrowseAccessLockOn;
        localStorage.clear();
      this.$store.state.wxBrowseAccessLockOn = wxBrowseAccessLockOn;
    }
};
/**
 * @name:
...
common.numToChinese = function(num) {
