...
;(function () {
    var bigPicShow = {
        ...
        addScale: function () {
            ...
            //         $("img", this).css({cursor: "pointer"}).attr("draggable",true);
            //         x = event.clientX;  //鼠标初始位置X
            //         y = event.clientY;  //鼠标初始位置Y
            //
            ...
            //
            //             resultX = parseInt(moveX) + parseInt(leftValue);
            //             resultY = parseInt(moveY) + parseInt(topValue);
            //
            //
            //             // //判断图形边界值
