        ...
        <section class="special-message-content ">
          <article class="special-message-item inline-message">
            ...
            <article class="special-message-item-text medical-report-name">
              ...
              <i class="J-sex icon-sex-male" v-if="medicalReportMsg.patientCasemap&&medicalReportMsg.patientCasemap.sexId == 1">男</i>
              <i class="J-sex icon-sex-female" v-if="medicalReportMsg.patientCasemap&&medicalReportMsg.patientCasemap.sexId == 2">女</i>
            ...
            <article class="special-message-item-text">
              <article class="special-message-item-list">
                <span class="answer"><p class="question">问诊目的：</p>{{medicalReportMsg.patientCasemap&&getMRTitle(medicalReportMsg.patientCasemap.caseType)}}</span>
              </article>
              <article class="special-message-item-list">
          ...
          <article class="special-message-item"
            ...
            <article class="special-message-item-text">
              ...
              <figcaption class="special-message-item-list"
                          v-if="medicalReportMsg.resultMainLis&&medicalReportMsg.resultMainList[0].symptomOptions[1].refQuestionList[1].questionName">
                <p class="question">疼痛性质：</p>
                <span class="answer"
                      style="display:inline-block;max-width:80%;vertical-align:top">{{medicalReportMsg.resultMainList[0].symptomOptions[1].refQuestionList[0].symptomOptions[0].optionName}}</span>
              </figcaption>
              <figcaption class="special-message-item-list"
                          v-if="medicalReportMsg.resultMainLis&&medicalReportMsg.resultMainList[0].symptomOptions[1].refQuestionList[1].questionName">
                <p class="question">VAS评分：</p>
                <span class="answer"
                      style="display:inline-block;max-width:80%;vertical-align:top">{{medicalReportMsg.resultMainList[0].symptomOptions[1].refQuestionList[1].symptomOptions[0].optionName}}</span>
              </figcaption>
              <figcaption class="special-message-item-list"
                          v-if="medicalReportMsg.patientCasemap.caseMain.caseAlong.length > 0">
                <p class="question">其他症状：</p>
                <span class="answer"
                      style="display:inline-block;max-width:80%;vertical-align:top">{{medicalReportMsg.patientCasemap.caseMain.caseAlong}}</span>
              </figcaption>
            </article>
          </article>
          <article class="special-message-item"
            ...
            <article class="special-message-item-list" v-if="medicalReportMsg.patientCasemap.treatmentName.length > 0">
              <span class="answer"><p class="question">曾就诊情况：</p>{{medicalReportMsg.patientCasemap.treatmentName}}&nbsp;&nbsp;&nbsp;{{medicalReportMsg.patientCasemap.illnessName}}</span>
            </article>
            <article class="special-message-item-list" v-if="medicalReportMsg.patientCasemap.takeMedicine.length > 0">
              <span class="answer"><p class="question">服用药物：</p>{{medicalReportMsg.patientCasemap.takeMedicine}}</span>
            </article>
            <figcaption class="special-message-item-list img-box"
                        v-if="medicalReportMsg.patientCasemap.attachmentList.length > 0">
              <figure class="special-message-item-img " v-for="imgs in medicalReportMsg.patientCasemap.attachmentList">
