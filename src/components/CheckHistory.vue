                                    ...
                                    <ul>
                                        <li v-for="ele in chatHistoryRecordList">
                                            <article>
                                                ...
                                                <figure v-if="ele.msgType.toLowerCase()==='custom' && ele.content.type==='deleteMsgTips'">
                                                    <span v-show="ele.content.data.deleteMsg.from ==='1_doctor00001'">{{ele.content.data.doctorName?ele.content.data.doctorName:'您'}}撤回了一条消息！</span>
                                                    <span v-show="ele.content.data.deleteMsg.from !=='1_doctor00001'">{{ele.content.data.from}}撤回了一条消息！</span>
                                                </figure>
