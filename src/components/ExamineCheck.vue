      ...
      <section class="check-suggestion-inner">
        <nav class="config-suggestion-tabsBox">
          <section class="config-suggestion-tabs ec-tabs tabsInner">
            ...
            <figure class="config-suggestion-tabs-item tabsItem" :class="{active:!tabActive}" @click="tabActive = false;FirstIndex = -1 ;secondIndex = -1 ;ThirdIndex =-1 ;FourIndex = -1" data-role="ac-tabs-2">检验建议</figure>
          </section>
        </nav>
