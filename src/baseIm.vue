                ...
                <transition-group name="fadeDown" tag="article">
                    <article class="messageList-item"
                        ...
                        <section v-if="items.type==='custom'&&items.content.type==='overtimeTip'" class="deleteMessage">
                            <span>{{items.content.data.doctorName?items.content.data.docName:'某某'+'医生超时未接诊'}}</span>
                        </section>
                        <!--医生超时未回复-->
                        <section v-if="items.type==='custom'&&items.content.type==='chatOvertimeTip'" class="deleteMessage">
                            <span>{{items.content.data.doctorName?items.content.data.docName:'某某'+'医生接诊后超时未回复'}}</span>
                        </section>
                        <!--医生拒绝-->
                        ...
                        <section v-if="items.type==='custom'&&items.content.type==='notification'&& JSON.parse(items.content).data.actionType == 4" class="deleteMessage">
                            <span>{{items.content.data.doctorName?items.content.data.docName:'某某'+'医生接诊'}}</span>
                        </section>
                    </article>
                </transition-group>
            </article>
...
//                            conId: that.orderSourceIdorderSourceId
            ...
            deleteMsg(item) {
                ...
                if (
                    item.custom &&
                    JSON.parse(item.custom).cId !== _this.$store.state.userId
                ) {
