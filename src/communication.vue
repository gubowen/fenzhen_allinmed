                ...
                <nav class="user-controller-fastBtn" data-template="tpl-fastReply">
                    ...
                    <transition name="fade">
                        <fast-Rely v-if="$store.state.fastReplyShow" :controllerInputStatus.sync="controllerInputStatus"
                                   :fastRelyStatus.sync="fastRelyStatus" :controllerInput.sync="controllerInput"></fast-Rely>
                    </transition>
                    <!--常用回复-->
                    <transition name="fade">
                        <used-Rely v-if="$store.state.usedReplyShow" :usedRelyStatus.sync="usedRelyStatus" :controllerInput.sync="controllerInput"></used-Rely>
                    </transition>
                    <transition name="fade">
